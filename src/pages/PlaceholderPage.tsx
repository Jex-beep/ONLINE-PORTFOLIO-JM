...
/** Temporary page shell for routes whose stage has not shipped yet. */
export function PlaceholderPage({ index, title, description }: PlaceholderPageProps) {
  return (
    <>
      ...
      <section className="container-x flex min-h-[70vh] flex-col justify-center pt-32 pb-24">
        <p className="font-mono text-xs tracking-[0.3em] text-gold uppercase">
          {index} <span aria-hidden="true">◆</span> Coming Soon
        </p>
